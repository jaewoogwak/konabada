                        ...
                        <div class="myinfo-detail">
                            <div class="unit">
                                ...
                                <div class="unit_content">
                                    <p class="desc desc_modify"> jaewoogwak</p>

                                </div>
                                <div class="unit">
                                    <h5 class="ptitle">이메일 </h5>
                                    <div class="unit_content">
                                        <p class="desc desc_modify"> <?php echo $email?>

                                    </div>
                                </div>
                                <div class="unit">
                                    <h5 class="ptitle">이름 </h5>
                                    <div class="unit_content">
                                        <p class="desc desc_modify"> <?php echo $username?>

                                    </div>
                                </div>
                                <div class="unit">
                                    <h5 class="ptitle">가입일 </h5>
                                    <div class="unit_content">
                                        <p class="desc desc_modify"> <?php echo $regDate?>
                ...
                <div class="cart">
                    ...
                    <div class="cart-container">
                        ...
                        <div class="empty">
                            ...
                            <a id="goItems" href="/course/items.php">매력적인 아이템 구매하러 가기</a>
